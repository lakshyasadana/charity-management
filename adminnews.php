...
<div class="container">
    ...
    <a href="#" class="heading"><h1>TITLI Cyclone:</h1></a><br>
    ...
    <a href="#" class="heading"><h1>HUDHUD Cyclone:</h1></a><br>
...
<!--kerala Floods -->
    <a href="#" class="heading"><h1>Kerala Floods:</h1></a><br>
    ...
    <!-- gaja cyclone -->
    <a href="#" class="heading"><h1>GAJA Cyclone:</h1></a><br>
    ...
    <!--cyclone meekenu -->
    <a href="#" class="heading"><h1>MEKUNU Cyclone:</h1></a><br>
...
<!-- tripura earthquake -->
    <a href="#" class="heading"><h1>TRIPURA Earthquake:</h1></a><br>
...
<!-- kashmir floods -->
    <a href="#" class="heading"><h1>KASHMIR Floods:</h1></a><br>
...
<footer width="100%" style="height: 125px;">
    <br><br>
    <h3 style="text-align: center">Thanks for using our Website.</h3>
</footer>
</body>
</html>